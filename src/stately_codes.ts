...
export const enum ErrorCode {
   ...
   */
  CachedSchemaTooOld = "CachedSchemaTooOld",
   ...
   * - Not Retryable
   */
  ItemReusedWithDifferentKeyPath = "ItemReusedWithDifferentKeyPath",
   ...
   * - Not Retryable
   */
  NonRecoverableTransaction = "NonRecoverableTransaction",
   ...
   * - Retryable
   */
  StoreRequestLimitExceeded = "StoreRequestLimitExceeded",
   ...
   */
  StoreThroughputExceeded = "StoreThroughputExceeded",
}
